...
% BSC201_APT is a class that inherits linearcontroller and defines the interface to 
% the ThorLabs BSC201 controller. This class works via Thor's APT ActiveX control system. 
%
