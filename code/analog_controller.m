...
% analog_controller is a class that inherits linearcontroller and defines the interface toan NI 
% device that controls a motion controller via an analog output.
%
